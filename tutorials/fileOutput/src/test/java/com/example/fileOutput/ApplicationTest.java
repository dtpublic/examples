...
public class ApplicationTest {
  ...
  private Configuration getConfig()
  {
    ...
    result.setInt("dt.operator.generator.prop.maxTuples", 4);
    result.setInt("dt.operator.generator.prop.divisor", 3);
    result.set("dt.operator.generator.attr.PARTITIONER",
               "com.datatorrent.common.partitioner.StatelessPartitioner:2");

    result.set("dt.operator.writer.prop.filePath", outputDirName);
    result.setInt("dt.operator.writer.prop.maxLength", 1024);
    result.set("dt.operator.writer.prop.fileName", "xyz");
    result.set("dt.operator.writer.attr.PARTITIONER",
               "com.datatorrent.common.partitioner.StatelessPartitioner:2");
    return result;
  }
